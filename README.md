...
### Brainstorm
- **What keywords should you be found for?**- The Primary, secondary keywords and other keywords for which we want to be found these are few ways to find out those keywords- Seed keywords, Keywords from SERP, Keywords from People search, Keyword finding tools, Competitor research, Google search console.
<table align="center">
  <tr>
